...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  */
    ...
    PB15     ------> USART1_RX
    */
    GPIO_InitStruct.Pin = RS232_2_TX_Pin|RS232_2_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  */
    ...
    PC7     ------> USART6_RX
    */
    GPIO_InitStruct.Pin = DEBUG_U_TX_Pin|DEBUG_U_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART9_MspDeInit 0 */
    ...
    PG1     ------> UART9_TX
    */
    HAL_GPIO_DeInit(GPIOG, GPS_RX_Pin|GPS_TX_Pin);
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PB15     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOB, RS232_2_TX_Pin|RS232_2_RX_Pin);
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PD9     ------> USART3_RX
    */
    HAL_GPIO_DeInit(GPIOD, RS232_1_TX_Pin|RS232_1_RX_Pin);
  ...
  /* USER CODE END USART6_MspDeInit 0 */
    ...
    PC7     ------> USART6_RX
    */
    HAL_GPIO_DeInit(GPIOC, DEBUG_U_TX_Pin|DEBUG_U_RX_Pin);
